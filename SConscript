...
#---------------------------------------------------------------------------------
_SOURCES_IGNORE = SOURCES_IGNORE + ['test.c', 'example.c'] 
_CPPPATH_IGNORE = CPPPATH_IGNORE + ['.git', 'example', 'doc', 'test'] 
